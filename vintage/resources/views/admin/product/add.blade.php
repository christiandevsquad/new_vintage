...
<form action="{{ action('ProductController@store')}}" method="put" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="col-6">
			<div class="form-group">
				...
				<input type="submit" class="btn btn-primary mr-sm-2 btn-sm" value="UPDATE">
				<button type="button" onclick="api/products" class="btn btn-warning btn-color mr-sm-2 btn-sm">CANCEL</button>
			...
			<div class="form-group">
				<input type="product-name" class="form-control" name="subName" value="{{ $product->subName }}">
			</div>
			<div class="form-group">
		...
		<div class="col-6">
			...
			<input type="product-name" class="form-control" name="tag" value="{{ $product->tag}}">
			<!-- 			
